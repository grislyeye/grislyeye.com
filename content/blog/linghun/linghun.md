...
I obtained a print-on-demand copy with an attractively haunting cover. Usually, Amazon pod books are of middling quality, but the wide-margined layout worked well with the format.

There was also some debate as to whether _Linghun_ was horror or fantasy. I was in the horror camp, but I was in the minority as well.
...
I thought _Linghun_ started well. The suburban emptiness of the town, and the gentle, meandering plot gave it an eerie, liminal tone. However, the consensus was that it sat awkwardly as a novella. It's either too long or too short, and might've worked better as either a short story or more elaborate novel. As it is, the ending is rushed and has a jarring tonal shift. It just didn't make the landing.
