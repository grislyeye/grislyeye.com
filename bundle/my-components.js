...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var MySection = class extends r4 {
    static styles = i`
    :host {
      display: block;
  ...
  var MyHeroHeader = class extends r4 {
    static styles = i`
    :host {
      display: block;
    }
  ...
  var MyNavigationBar = class _MyNavigationBar extends r4 {
    static styles = i`
    :host {
      display: flex;
  ...
  var MyPreview = class _MyPreview extends r4 {
    static styles = i`
    :host {
  ...
  var MyProduct = class extends r4 {
    static styles = i`
    :host {
      display: block;
      padding-bottom: 1em;
