...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var P = (t4, i4) => {
    ...
    return [C(t4, l4 + (t4[s3] || "<?>") + (2 === i4 ? "</svg>" : "")), o2];
  };
  var V = class _V {
    constructor({ strings: t4, _$litType$: s3 }, n2) {
      ...
      this.parts = [];
      let c3 = 0, a2 = 0;
      const u3 = t4.length - 1, d3 = this.parts, [f4, v2] = P(t4, s3);
      if (this.el = _V.createElement(f4, n2), E.currentNode = this.el.content, 2 === s3) {
        const t5 = this.el.content.firstChild;
        t5.replaceWith(...t5.childNodes);
      }
      for (; null !== (r3 = E.nextNode()) && d3.length < u3; ) {
        if (1 === r3.nodeType) {
          if (r3.hasAttributes()) for (const t5 of r3.getAttributeNames()) if (t5.endsWith(e)) {
            ...
            d3.push({ type: 1, index: c3, name: e3[2], strings: s4, ctor: "." === e3[1] ? k : "?" === e3[1] ? H : "@" === e3[1] ? I : R }), r3.removeAttribute(t5);
          ...
          if ($.test(r3.tagName)) {
            ...
            if (s4 > 0) {
              ...
              for (let i4 = 0; i4 < s4; i4++) r3.append(t5[i4], l()), E.nextNode(), d3.push({ type: 2, index: ++c3 });
              r3.append(t5[s4], l());
            }
          }
  ...
  function N(t4, i4, s3 = t4, e3) {
    if (i4 === w) return i4;
    let h3 = void 0 !== e3 ? s3._$Co?.[e3] : s3._$Cl;
    const o2 = c(i4) ? void 0 : i4._$litDirective$;
    return h3?.constructor !== o2 && (h3?._$AO?.(false), void 0 === o2 ? h3 = void 0 : (h3 = new o2(t4), h3._$AT(t4, s3, e3)), void 0 !== e3 ? (s3._$Co ??= [])[e3] = h3 : s3._$Cl = h3), void 0 !== h3 && (i4 = N(t4, h3._$AS(t4, i4.values), h3, e3)), i4;
  }
  var S = class {
    constructor(t4, i4) {
    ...
    u(t4) {
      ...
      E.currentNode = e3;
      let h3 = E.nextNode(), o2 = 0, n2 = 0, l4 = s3[0];
      for (; void 0 !== l4; ) {
        if (o2 === l4.index) {
          let i5;
          2 === l4.type ? i5 = new M(h3, h3.nextSibling, this, t4) : 1 === l4.type ? i5 = new l4.ctor(h3, l4.name, l4.strings, this, t4) : 6 === l4.type && (i5 = new L(h3, this, t4)), this._$AV.push(i5), l4 = s3[++n2];
        }
        o2 !== l4?.index && (h3 = E.nextNode(), o2++);
      }
      return E.currentNode = r, e3;
    }
    p(t4) {
      let i4 = 0;
  ...
  var M = class _M {
    ...
    constructor(t4, i4, s3, e3) {
      this.type = 2, this._$AH = T, this._$AN = void 0, this._$AA = t4, this._$AB = i4, this._$AM = s3, this.options = e3, this._$Cv = e3?.isConnected ?? true;
    }
    get parentNode() {
    ...
    $(t4) {
      const { values: i4, _$litType$: s3 } = t4, e3 = "number" == typeof s3 ? this._$AC(t4) : (void 0 === s3.el && (s3.el = V.createElement(C(s3.h, s3.h[0]), this.options)), s3);
      if (this._$AH?._$AD === e3) this._$AH.p(i4);
      else {
        const t5 = new S(e3, this), s4 = t5.u(this.options);
    ...
    k(t4) {
      ...
      const i4 = this._$AH;
      let s3, e3 = 0;
      for (const h3 of t4) e3 === i4.length ? i4.push(s3 = new _M(this.S(l()), this.S(l()), this, this.options)) : s3 = i4[e3], s3._$AI(h3), e3++;
  ...
  var R = class {
    ...
    constructor(t4, i4, s3, e3, h3) {
      this.type = 1, this._$AH = T, this._$AN = void 0, this.element = t4, this.name = i4, this._$AM = e3, this.options = h3, s3.length > 2 || "" !== s3[0] || "" !== s3[1] ? (this._$AH = Array(s3.length - 1).fill(new String()), this.strings = s3) : this._$AH = T;
    }
    _$AI(t4, i4 = this, s3, e3) {
      const h3 = this.strings;
      let o2 = false;
      if (void 0 === h3) t4 = N(this, t4, i4, 0), o2 = !c(t4) || t4 !== this._$AH && t4 !== w, o2 && (this._$AH = t4);
      else {
        const e4 = t4;
        let n2, r3;
        for (t4 = h3[0], n2 = 0; n2 < h3.length - 1; n2++) r3 = N(this, e4[s3 + n2], i4, n2), r3 === w && (r3 = this._$AH[n2]), o2 ||= !c(r3) || r3 !== this._$AH[n2], r3 === T ? t4 = T : t4 !== T && (t4 += (r3 ?? "") + h3[n2 + 1]), this._$AH[n2] = r3;
      }
      o2 && !e3 && this.j(t4);
    }
    j(t4) {
  ...
  var I = class extends R {
    ...
    _$AI(t4, i4 = this) {
      ...
      const s3 = this._$AH, e3 = t4 === T && s3 !== T || t4.capture !== s3.capture || t4.once !== s3.once || t4.passive !== s3.passive, h3 = t4 !== T && (s3 === T || e3);
  ...
  var j = (t4, i4, s3) => {
    ...
    if (void 0 === h3) {
      ...
      e3._$litPart$ = h3 = new M(i4.insertBefore(l(), t5), t5, void 0, s3 ?? {});
    }
  ...
  var r2 = null;
  var i2 = { boundAttributeSuffix: z.P, marker: z.A, markerMatch: z.C, HTML_RESULT: z.M, getTemplateHtml: z.L, overrideDirectiveResolve: (e3, t4) => class extends e3 {
    _$AS(e4, r3) {
      return t4(this, r3);
    }
  ...
  var m2 = (t4, r3, a2, p3) => {
    ...
    if (f4 = d2(m3, f4), f4 === w) a2.push({ part: m3, type: "leaf" });
  ...
  globalThis.litElementHydrateSupport = ({ LitElement: s3 }) => {
    ...
    s3.prototype.update = function(s4) {
      ...
      } else j(h4, this.renderRoot, this.renderOptions);
    };
  };
})();
